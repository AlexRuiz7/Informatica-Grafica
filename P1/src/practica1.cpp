...
// Variable de control para el dibujado de las normales
bool normals = false;
...
void draw_objects(){
	...
	if(normals)				_objects[object].drawNormals();
...
void special_keys(int Tecla1, int x, int y){
	...
	switch (Tecla1){
		case GLUT_KEY_F1:					changeObject(0);					break;	//object=_objects[0];
		case GLUT_KEY_F2:					changeObject(1);					break;	//object=_objects[1];
